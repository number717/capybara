...
Capybara.register_driver :selenium_legacy_firefox do |app|
...
module TestSessions
  Selenium = Capybara::Session.new(:selenium_legacy_firefox, TestApp)
end
...
RSpec.describe "Capybara::Session with legacy firefox" do
  include_examples  "Capybara::Session", TestSessions::Selenium, :selenium_legacy_firefox
end
